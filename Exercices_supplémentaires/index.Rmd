...
Il est d'ailleurs possible de séparer la route en emprunter en 4 sections:
...
<img src="assets/img/region4.PNG" height="70px"></img>
</div>
...
Reprenons l'exemple 5 des exercices supplémentaires de l'atelier 1. Remarquons d'abord que les sections 3 et 4 ont été modifiés. 
...
Voici une fonction qui permet de déterminer l'emplacement (la coordonnée x et y du plan cartésien) après chaque déplacement de Rémi. Les arguments de cette fonction sont définis comme suit:
