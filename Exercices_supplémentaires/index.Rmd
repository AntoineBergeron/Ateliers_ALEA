...
*Rappelons que le premier argument doit être les valeurs sur l’axe des x (soit des valeurs de 1 à 1000 représentants chacune des données) et que les valeurs en y doivent être les valeurs centrées réduites.
