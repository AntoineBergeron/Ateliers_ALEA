...
```{r}
calcul_sac(sac_farine <- rnorm(n = 1000, mean = 250, sd = 5))
calcul_sac(sac_farine <- rnorm(n = 1000, mean = 250, sd = 5))
calcul_sac(sac_farine <- rnorm(n = 1000, mean = 250, sd = 5))
```
...
Pour ce faire, créez une boucle évaluant la fonction pour des valeurs de x allant de 0 à 100. Gardez ces valeurs dans un vecteur y.
